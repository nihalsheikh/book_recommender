...
missing_count = books["large_thumbnail"].isna().sum()

# Generate random covers for all missing thumbnails
random_covers = [random.choice(cover_files) for _ in range(missing_count)]

# Select a book cover randomly. New approach
books.loc[books["large_thumbnail"].isna(), "large_thumbnail"] = random_covers
...
# making Dashboard with gradio
with gr.Blocks() as dashboard:
    gr.Markdown("# Semantic Book Recommender")

    with gr.Row():
        user_query = gr.Textbox(label = "Please enter a description of a book:", placeholder="e.g., A story about finding treasure")
